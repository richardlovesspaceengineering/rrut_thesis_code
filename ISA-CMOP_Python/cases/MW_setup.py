...
class MWSetup(Setup):
    ...
    def g3(self, x):
        contrib = 2.0 * np.power(
            x[self.n_objectives - 1 :]
            + (x[self.n_objectives - 2 : -1] - 0.5)
            * (x[self.n_objectives - 2 : -1] - 0.5)
            - 1.0,
            2.0,
        )
...
class MW1(MWSetup):
    ...
    def obj_func_specific(self, x):
        ...
        cons[0] = (
            ...
            - 1
            - self.LA1(
                0.5, 2.0, 1.0, 8.0, np.sqrt(2.0) * obj[1] - np.sqrt(2.0) * obj[0]
            )
        )
        return obj, cons
...
class MW2(MWSetup):
    ...
    def obj_func_specific(self, x):
        ...
        cons[0] = (
            ...
            - 1
            - self.LA1(
                0.5, 3.0, 1.0, 8.0, np.sqrt(2.0) * obj[1] - np.sqrt(2.0) * obj[0]
            )
        )
        return obj, cons
...
class MW3(MWSetup):
    ...
    def obj_func_specific(self, x):
        ...
        cons[0] = (
            ...
            - 1.05
            - self.LA1(
                0.45, 0.75, 1.0, 6.0, np.sqrt(2.0) * obj[1] - np.sqrt(2.0) * obj[0]
            )
        )
        cons[1] = (
            0.85
            ...
            - obj[1]
            + self.LA1(
                0.3, 0.75, 1.0, 2.0, np.sqrt(2.0) * obj[1] - np.sqrt(2.0) * obj[0]
            )
        )
        return obj, cons
...
class MW5(MWSetup):
    ...
    def obj_func_specific(self, x):
        ...
        cons[0] = (
            obj[0] ** 2
            + obj[1] ** 2
            - np.power(1.7 - self.LA2(0.2, 2.0, 1.0, 1.0, atan), 2.0)
        )
        t = 0.5 * np.pi - 2 * np.abs(atan - 0.25 * np.pi)
        cons[1] = (
            np.power(1 + self.LA2(0.5, 6.0, 3.0, 1.0, t), 2.0)
            - obj[0] ** 2
            - obj[1] ** 2
        )
        cons[2] = (
            np.power(1 - self.LA2(0.45, 6.0, 3.0, 1.0, t), 2.0)
            - obj[0] ** 2
            - obj[1] ** 2
        )
        return obj, cons
...
class MW6(MWSetup):
    ...
    def obj_func_specific(self, x):
        ...
        cons[0] = (
            obj[0] ** 2 / np.power(1.0 + self.LA3(0.15, 6.0, 4.0, 10.0, atan), 2.0)
            + obj[1] ** 2 / np.power(1.0 + self.LA3(0.75, 6.0, 4.0, 10.0, atan), 2.0)
            - 1
        )
        return obj, cons
...
class MW7(MWSetup):
    ...
    def obj_func_specific(self, x):
        ...
        cons[1] = (
            np.power(1.15 - self.LA2(0.2, 4.0, 1.0, 8.0, atan), 2.0)
            - obj[0] ** 2
            - obj[1] ** 2
        )
        return obj, cons
...
class MW9(MWSetup):
    ...
    def obj_func_specific(self, x):
        ...
        t1 = (1 - 0.64 * obj[0] * obj[0] - obj[1]) * (
            1 - 0.36 * obj[0] * obj[0] - obj[1]
        )
        t2 = (1.35 * 1.35 - (obj[0] + 0.35) * (obj[0] + 0.35) - obj[1]) * (
            1.15 * 1.15 - (obj[0] + 0.15) * (obj[0] + 0.15) - obj[1]
        )
...
class MW10(MWSetup):
    ...
    def obj_func_specific(self, x):
        ...
        cons[0] = (
            -1.0
            * (2.0 - 4.0 * obj[0] * obj[0] - obj[1])
            * (2.0 - 8.0 * obj[0] * obj[0] - obj[1])
        )
        cons[1] = (2.0 - 2.0 * obj[0] * obj[0] - obj[1]) * (
            2.0 - 16.0 * obj[0] * obj[0] - obj[1]
        )
        cons[2] = (1.0 - obj[0] * obj[0] - obj[1]) * (
            1.2 - 1.2 * obj[0] * obj[0] - obj[1]
        )
        return obj, cons
...
class MW11(MWSetup):
    ...
    def obj_func_specific(self, x):
        ...
        cons[0] = (
            -1.0
            * (3.0 - obj[0] * obj[0] - obj[1])
            * (3.0 - 2.0 * obj[0] * obj[0] - obj[1])
        )
        cons[1] = (3.0 - 0.625 * obj[0] * obj[0] - obj[1]) * (
            3.0 - 7.0 * obj[0] * obj[0] - obj[1]
        )
        cons[2] = (
            -1.0
            * (1.62 - 0.18 * obj[0] * obj[0] - obj[1])
            * (1.125 - 0.125 * obj[0] * obj[0] - obj[1])
        )
        cons[3] = (2.07 - 0.23 * obj[0] * obj[0] - obj[1]) * (
            0.63 - 0.07 * obj[0] * obj[0] - obj[1]
        )
        return obj, cons
...
class MW13(MWSetup):
    ...
    def obj_func_specific(self, x):
        ...
        obj[0] = g * x[0]
        obj[1] = g * (
            5.0 - np.exp(obj[0] / g) - np.abs(0.5 * np.sin(3 * np.pi * obj[0] / g))
        )
        ...
        cons[0] = (
            ...
            * (
                5.0
                - (1 + obj[0] + 0.5 * obj[0] * obj[0])
                - 0.5 * np.sin(3 * np.pi * obj[0])
                - obj[1]
            )
