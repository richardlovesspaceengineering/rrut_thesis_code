...
class CCMO(EvolutionaryAlgorithm):
    ...
    def _initialise(self):
        ...
        self.da = Population(self.problem)
        ...
        self.population, self.da = self.survival1.do(self.problem, self.population, self.da, self.n_population)
        ...
        self.aux_population = 'eps'  # 'unconstrained', 'eps'
    ...
    def _next(self):
        ...
        cons = self.population.extract_cons()
    ...
    def _plot_populations(self, pop, aux, aux_in_pop, pop_in_aux):
        ...
        plt.savefig(f'/home/juan/Desktop/ccmo_viz/ccmo_cada_safr_eps_{self.problem.name}_gen_{self.n_gen-1}.png')
        # plt.show()
