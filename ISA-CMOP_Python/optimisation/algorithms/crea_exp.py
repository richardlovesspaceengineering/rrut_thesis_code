...
class CREA(EvolutionaryAlgorithm):
    ...
    def _initialise(self):
        ...
        self.n_infill = 1
        self.w_max_0 = 20           # Number of initial internal offspring generations
        self.w_max_f = 1            # Number of final internal offspring generations
        self.n_offspring = 300
        self.n_total = self.w_max_0 * self.n_offspring        
    ...
    def _next(self):
        # Adapt number of internal offspring generations & n_offspring
        self.w_max = int(self.w_max_0 - ((self.w_max_0 - self.w_max_f) / self.max_f_eval) * (self.evaluator.n_eval - self.n_init))
        # self.n_offspring = int(300 + (2970 / 19) * (20-self.w_max))
        self.n_offspring = int(self.n_total / self.w_max)
        print('n_eval:', self.evaluator.n_eval - self.n_init, 'w_max: ', self.w_max, 'n_offs: ', self.n_offspring, 'n_total:', self.w_max*self.n_offspring) 
