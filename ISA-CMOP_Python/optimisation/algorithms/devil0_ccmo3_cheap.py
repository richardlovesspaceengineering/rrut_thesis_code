...
class DEVIL(SAEvolutionaryAlgorithm):
    ...
    def generate_offspring(self, representatives, n_offspring):
        ...
        for gen in range(self.w):
            ...
            offspring = self.generate_ga_de_offspring(survived, n_offspring=n_offspring, evaluate=False)

            # # TODO: Inexpensive obj & constraints ----------------------------------------------------------------------------
            offspring = self.surrogate_evaluator.do(self.problem.obj_func, self.problem, copy.deepcopy(offspring))
            # # TODO: Inexpensive obj & constraints ----------------------------------------------------------------------------
