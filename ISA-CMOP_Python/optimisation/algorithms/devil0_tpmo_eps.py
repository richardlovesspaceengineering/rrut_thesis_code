...
class DEVIL(SAEvolutionaryAlgorithm):
    ...
    def generate_offspring(self, representatives, n_offspring):
        ...
        eps_population = self.transform_population(self.population)
        ...
        selected = self.rank_and_crowd._do(self.problem, eps_population, int(n_offspring / 5), cons_val=eps_population.extract_cons_sum())
        survived = self.population[selected]
