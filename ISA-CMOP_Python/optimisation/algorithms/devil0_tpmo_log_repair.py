...
class DEVIL(SAEvolutionaryAlgorithm):
    ...
    def _next(self):
        ...
        surv_list = ['rcrowd', 'thor', 'eps-safr']
        print(f"Using: {surv_list[self.last_selected]}")
    ...
    def attempt_solution_repair(self, infill, opt):
        ...
        x_repaired = self.repair_solution(infill, eps=1e-3, n_perturb=50 * self.problem.n_var, perturb_scale=20)  # eps=1e-3, n_perturb=1000, perturb_scale=3
    ...
    def repair_solution(self, infill, eps=1e-4, perturb_scale=3, n_perturb=1000):
        ...
        for i in range(n_perturb):
            ...
            alpha = perturb_scale * np.random.uniform(0.05, 1.0, self.problem.n_con)
