...
class SAPREA(SAEvolutionaryAlgorithm):
    ...
    def _next(self):
        ...
        infill = self.probabilistic_infill_selection(self.offspring, n_survive=self.n_infill, probabilistic=False)
        ...
        if self.evaluator.n_eval > (self.max_f_eval - 1):
            ...
            for i in range(len(indices)):
                ...
                plt.savefig(f'/home/juan/Desktop/stock_williams_opt_airfoil_re_1e5{i}.png')
                plt.close()
    ...
    def generate_offspring(self, representatives, n_offspring):
        ...
        for gen in range(self.w):
            ...
            survived = self.probabilistic_infill_selection(offspring, n_survive=int(n_offspring / 5), probabilistic=True)
