...
class SATLBO(EvolutionaryAlgorithm):
    ...
    def _initialise(self):
        ...
        self.n_infill_total = 10    ## SATLBO11 --> Test reducing exploration infills to 4 to improvee CEC probs
        ...
        self.population = copy.deepcopy(self.surrogate.population)   ## SATLBO12
    ...
    def _next(self):
        ...
        self.population = copy.deepcopy(temp_population)    ### SALTBO12
