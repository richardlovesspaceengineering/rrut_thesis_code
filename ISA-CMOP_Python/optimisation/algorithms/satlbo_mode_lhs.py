...
class SATLBO(EvolutionaryAlgorithm):
    ...
    def _next(self):
        ...
        best_population = self.survival.do(self.problem, self.surrogate.population, self.n_population / 2, gen=self.n_gen,
        ...
        initialise.do(int(self.n_population / 2), x_lower=self.problem.x_lower, x_upper=self.problem.x_upper)
        x_init = initialise.x
        temp_population = Population(self.problem, int(self.n_population / 2))
        temp_population.assign_var(self.problem, x_init)
        temp_population = Population.merge(best_population, temp_population)
        # self.population.assign_var(self.problem, x_init)
