...
class tDEADP(EvolutionaryAlgorithm):
    ...
    def __init__(self,
                 ...
                 n_population=109,
                 surrogate=None,
                 sampling=LatinHypercubeSampling(),  #   RandomSampling(),
    ...
    def _initialise(self):
        ...
        self.pareto_surrogate = self.initialise_classifier(flag='pareto')
        self.theta_surrogate = self.initialise_classifier(flag='theta')
    ...
    def _next(self):
        ...
        self.update_classifier(flag='pareto')
        self.update_classifier(flag='theta')
