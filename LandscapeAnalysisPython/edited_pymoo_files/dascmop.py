# NEEDED TO MAKE SOME CHANGES TO THE DASCMOP FILE TO ALLOW SCALABLE DIMENSIONS.
# REPLACE THE dascmop.py FILE IN /home/kj66/Documents/Richard/venv/lib/python3.8/site-packages/pymoo/problems/multi with this code
...
class DASCMOP(Problem):
    def __init__(self, n_var, n_obj, n_ieq_constr, difficulty, **kwargs):
        super().__init__(
            n_var=n_var,
            n_obj=n_obj,
    ...
    def _calc_pareto_front(self, *args, **kwargs):
        return Remote.get_instance().load(
            ...
            "pf",
            "DASCMOP",
            f"{str(self.__class__.__name__).lower()}_{self.difficulty}.pf",
        )


class DASCMOP1(DASCMOP):
    def __init__(self, n_var, difficulty, **kwargs):
        super().__init__(n_var=n_var, n_obj=2, n_ieq_constr=11, difficulty=difficulty)
...
class DASCMOP7(DASCMOP):
    def __init__(self, n_var, difficulty, **kwargs):
        super().__init__(n_var=n_var, n_obj=3, n_ieq_constr=7, difficulty=difficulty)
