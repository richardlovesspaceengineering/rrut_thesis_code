...
class RandomWalkAnalysis(Analysis):
    ...
    def preprocess_nans_on_walks(self):
        ...
        Might be useful to develop this function further if implementing RWs for aerofoils.

        """
        pop_walk_new, _ = self.pop_walk.remove_nan_inf_rows()
        ...
        for i in range(var.shape[0]):
            ...
            pop_neighbourhood, _ = pop_neighbourhood.remove_nan_inf_rows()
    ...
    def compute_neighbourhood_distance_features(self, norm_method):
        """
        Calculate neighbourhood distance features on the normalised search, objective and constraint spaces.
        """
    ...
    def compute_neighbourhood_hv_features(
        ...
        """
        Determine neighbourhood HV features.

        This function is used for both feasible and unconstrained spaces.
        """
    ...
    def compute_neighbourhood_violation_features(self, norm_method):
        ...
        # Maximum ratio of feasible boundary crossing. Used implementation from MODAct paper.
