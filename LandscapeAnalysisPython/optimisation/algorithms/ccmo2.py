...
class CCMO2(EvolutionaryAlgorithm):
    ...
    def _next(self):
        ...
        self.offspring = self.generate_ga_de_offspring(self.reps, self.n_population)
        ...
        self.population2 = Population.merge(self.population2, self.offspring)
        self.population3 = Population.merge(self.population3, self.offspring)
    ...
    def generate_ga_de_offspring(self, survived, n_offspring):
        ...
        offspring1 = self.de_mutation.do(survived, self.population3, int(n_offspring / 4))
        offspring1 = self.repair.do(self.problem, offspring1)

        # Generate transfer-DE offspring (URCMO)
        offspring2 = self.create_de_offspring(self.population, self.population3, int(n_offspring / 4))
    ...
    def _plot_populations(self, pop1, pop2, pop3):
        ...
        plt.savefig(f'/home/juan/Desktop/ccmo_viz/ccmo2_gade2_active_{self.problem.name}_gen_{self.n_gen-1}.png')
        # plt.show()
