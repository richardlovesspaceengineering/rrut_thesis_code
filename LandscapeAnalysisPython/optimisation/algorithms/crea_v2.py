...
class CREA(SAEvolutionaryAlgorithm):
    ...
    def _initialise(self):
        ...
        #                           c=0.5, p_type='linear', kernel_type='multiquadratic',
        #                           width_range=(0.1, 2), max_evals=50, verbose=True)
        # self.n_rbf_update = 25
    ...
    def _next(self):
        ...
        if len(infill_population) == 0:
            ...
            if rand_val < 0.5:
                ...
                # Select most diverse offspring to the current population (decision-space)
                infill_population = self.decision_space_diversity(self.offspring, n_survive=self.n_infill,
                                                                  pop_to_compare=self.population)
                print('-----------------No infill point was found! Selecting most decision-space diverse offspring ---')
