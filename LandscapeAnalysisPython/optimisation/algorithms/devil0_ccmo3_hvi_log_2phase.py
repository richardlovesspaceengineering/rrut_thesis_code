...
class DEVIL(SAEvolutionaryAlgorithm):
    ...
    def _next(self):
        ...
        if self.feasible_frac == 0.0:
            ...
            self.offspring = self.generate_dcv_offspring(self.opt, n_offspring=self.n_offspring)
    ...
    def dcv_infill_selection(self, offspring, n_survive=1):
        ...
        dcv_opt = self.calc_dcv(self.opt, lowest_cv=self.lowest_cv)
