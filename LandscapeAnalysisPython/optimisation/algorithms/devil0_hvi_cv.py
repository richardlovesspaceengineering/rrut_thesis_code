...
class DEVIL(SAEvolutionaryAlgorithm):
    ...
    def generate_cv_offspring(self, representatives, n_offspring):
        ...
        cv_pop = self.calc_cv(self.population)
        best_feas_arr = self.population[np.array([np.argmin(cv_pop)])].extract_obj()
        ...
        #                  obj_array2=np.atleast_2d(obj_arr[selected]),
        #                  obj_array3=np.atleast_2d(best_feas_arr))
