    ...
    def generate_offspring(self, representatives, n_offspring):
        ...
        for gen in range(self.w):
            ...
            if self.last_selected == 0:
                ...
                # print('safr')
                # survived = self.two_rank_survival.do(self.problem, offspring, n_survive=int(n_offspring / 5))  # devil0_rcrowd_and_thor
                survived = self.safr_survival.do(self.problem, offspring, n_survive=int(n_offspring / 5))      # devil0_rcrowd_and_safr
