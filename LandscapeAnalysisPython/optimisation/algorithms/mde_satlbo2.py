...
class MDE_SATLBO(EvolutionaryAlgorithm):
    ...
    def _next(self):
        ...
        optimal_population = self.local_minima_exploitation(obj_surrogates, top_ranked_population,
                                                        n_population=75, n_generations=20, n_return=1)  # Max 1 point per RBF kernel
    ...
    def satlbo(self, obj_surrogates, init_population, n_generations=30, n_population=30, n_survive=1):
        ...
        # Determine the Teacher from surrogate population
        new_teacher = init_population[0]
    ...
    def local_minima_exploitation(self, obj_surrogates, init_population, n_population=75, n_generations=20, n_survive=6, n_return=1):
        ...
        # Duplicates with different kernel optima
    ...
    def modal_sort_and_ranking(self, population, surrogate, n_survived, stop_at_cluster=10, cosine=True):
        ...
        samples = np.linspace(0.0, 1.0, self.problem.n_var+2)[1:-1]
