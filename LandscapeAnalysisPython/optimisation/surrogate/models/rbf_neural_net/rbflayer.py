...
class RBFLayer(Layer):
    ...
    def __init__(self, output_dim, initializer=None, betas=1.0, kernel='gaussian', **kwargs):
    ...
    def call(self, x):
        ...
        if self.kernel == 'gaussian':
            ...
            return -self.betas * tf.math.reduce_sum(H, axis=1) ** 3
        elif self.kernel == 'multiquadratic':
            return tf.math.sqrt(tf.math.reduce_sum(H**2, axis=1) + tf.math.reduce_sum(tf.transpose(C)**2, axis=1))
